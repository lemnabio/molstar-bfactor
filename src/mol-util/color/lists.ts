...
export const ColorLists = {
    ...
    'twilight': ColorList('Twilight', 'cyclical',
        'Twilight, cyclical color scheme from Matplotlib, perceptually uniform shades of white-blue-black-red-white',
    ...
    'rainbow': ColorList('Rainbow', 'cyclical',
        'Rainbow, cyclical color scheme from D3.js',
    ...
    'sinebow': ColorList('Sinebow', 'cyclical',
        'Sinebow, cyclical color scheme from D3.js',
